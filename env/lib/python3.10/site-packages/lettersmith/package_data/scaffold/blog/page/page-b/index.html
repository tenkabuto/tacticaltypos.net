...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta property="og:title" content="Page B | Tactical Typos" />
    ...
    <title>Page B | Tactical Typos</title>
    <!-- Bootstrap core CSS -->
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      <article class="blog-post">
        <h1 class="blog-post-title">Page B</h1>
        <p>Example link to <a href="https://tacticaltypos.net/env/lib/python3.10/site-packages/lettersmith/package_data/scaffold/blog/page/page-a/" class="wikilink">page A</a>.</p>

      </article>
    </div>
    <aside class="col-md-4 blog-sidebar">
      <div class="p-3 mb-3 bg-white rounded">
        <p class="text-secondary">Last edited 2023-05-01 20:36:37.199485</p>
        <h4 class="font-italic mt-3">Backlinks</h4>
        <ul class="list-unstyled">
        
	    	<li><a class="wikilink" href="/env/lib/python3.10/site-packages/lettersmith/package_data/scaffold/blog/page/page-a/">Page A</a><br>Example link to page B</p>
	  	
	    	<li><a class="wikilink" href="/src/lettersmith/lettersmith/package_data/scaffold/blog/page/page-a/">Page A</a><br>Example link to page B</p>
